                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            ...
                            <button type="button" class="btn custom-bg text-white shadow-none btn-sm" data-bs-toggle="modal" data-bs-target="#general-s">
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            ...
                            <button type="button" class="btn custom-bg text-white shadow-none btn-sm" data-bs-toggle="modal" data-bs-target="#contacts-s">
                                <i class="bi bi-pencil-square"></i> Edit
                            </button>
                        </div>
                        <div class="row">
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            ...
                            <button type="button" class="btn custom-bg text-white shadow-none btn-sm" data-bs-toggle="modal" data-bs-target="#team-s">
                        ...
                        <div class="row" id="team-data">
                            <div class="col-md-2 mb-3">
                                ...
                                <img src="../images/About/hev.jfif" class="card-img">
                                    <div class="card-img-overlay text-end">
                                        <button type="button" class="btn btn-danger btn-sm shadow-none">
                                            <i class="bi bi-trash"></i> Delete
                                        </button>
                                    </div>
                                    <p class="card-text text-center px-3 py-2">Beb Avi</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        function add_member()
        {
            ...
            xhr.onload = function(){
                ...
                if(this.responseText == 'inv_img'){
                    alert('error','Only JPG and PNG format are allowed!');
                }
