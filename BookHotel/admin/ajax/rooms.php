   ...
   if(isset($_POST['get_all_rooms']))
    {
        ...
        {
            if($row['status']==1){
                $status = "<button onclick='toggle_status($row[id],0)' class='btn dark-maroon text-light btn-sm shadow-none'>Active</button>";
            }
            else{
                $status = "<button onclick='toggle_status($row[id],1)' class='btn btn-warning text-light btn-sm shadow-none'>Inactive</button>";
            }
            ...
            $data.="
                <tr class='align-middle'>
                    ...
                    <td>$status</td>
                    <td>
                        <button type='button' onclick='edit_details($row[id])' class='btn maroon text-light shadow-none btn-sm' data-bs-toggle='modal' data-bs-target='#edit-room'>
