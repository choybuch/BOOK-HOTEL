<?php 
    ...
    if(isset($_POST['get_bookings']))
    {
        ...
        ORDER BY bo.booking_id DESC";
            ...
            $res = select($query,["%$frm_data[search]%","%$frm_data[search]%","%$frm_data[search]%"],'ssss');
            ...
            {
                $data = date("d-m-Y",strtotime($date['datentime']));
                ...
                $table_data .="
                    ...
                    <td>
                        ...
                        <br>
                        <b>Price:</b> PHP$data[price]
                    </td>
                    <td>
                        <b>Amount:</b> PHP$data[trans_amt]
                        <br>
                        <b>Date:</b> $date
                    </td>
                    <td>
                    ...
                    <td>
                        <button type='button' onclick='download($data[booking_ids])'class='mt-2 btn btn-success btn-sm fw-bold shadow-none'>
    ...
    //     echo $res;
    // }
    // nidelete nya to ya. nicomment out ko nalang baka sakaling kailanganin
?>