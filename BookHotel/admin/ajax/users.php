        ...
        while($row = mysqli_fetch_assoc($res))
        {
           ...
           // $verified = "<span class='badge bg-warning'><i class='bi bi-x-lg'></i></span>";
            ...
            //}
                ...
                $status = "<button onclick='toggle_status($row[id],0)' class='btn dark-maroon text-light btn-sm shadow-none'>
                active
                </button>";

            if(!$row['status']){
                $status = "<button onclick='toggle_status($row[id],1)' class='btn btn-danger text-light btn-sm shadow-none'>
                inactive
                </button>";
            }
