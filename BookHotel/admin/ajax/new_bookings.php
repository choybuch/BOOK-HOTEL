<?php 
    ...
    if(isset($_POST['get_bookings']))
    {
        ...
        AND (bo.booking_status='booked' AND bo.arrival=0) ORDER BY bo.booking_id ASC";
            ...
            while($data = mysqli_fetch_assoc($res))
            {
                ...
                $table_data .="
                    ...
                    <td>
                        ...
                        <br>
                        <button type='button' onclick='cancel_booking($data[booking_ids])' class='mt-2 btn btn-outline-danger btn-sm fw-bold shadow-none'>
                            <i class='bi bi-trash'></i>Cancel Boooking
                        </button>
                    </td>
                    </tr>
                ";
